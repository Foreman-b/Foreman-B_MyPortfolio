<img src= "https://github.com/Foreman-b/Foreman-B_Portfolio1/blob/main/Demo.jpg">
...
### Setup
 ...
 ```bash
git clone https://github.com/Foreman-b/Foreman-B_Portfolio1.git
 ```
 2. Navigate to the project directory:
```bash
 cd 'Foreman-B_Portfolio1/Foreman-B_Portfolio'
```
...
- Altering the credit notice ("Developed with ❤️ by Foreman-B") in the footer is not allowed.
